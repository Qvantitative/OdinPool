  ...
  return (
    <>
      <nav className="bg-gray-900 text-white px-4 py-3 shadow-md flex justify-between items-center" aria-label="Main Navigation">
        {/* Left Side - Blocks, Trending, Bubble Maps, Wallet */}
        <div className="flex items-center space-x-4">
          <button className="text-lg font-semibold hover:text-pink-500" onClick={() => router.push('/app/analytics')}>
            Blocks
          </button>
          <button className="text-lg font-semibold hover:text-pink-500" onClick={() => router.push('/app/trending')}>
            Trending
          </button>
          <button className="text-lg font-semibold hover:text-pink-500" onClick={() => router.push('/app/bubble-maps')}>
            Bubble Maps
          </button>
          <button className="text-lg font-semibold hover:text-pink-500" onClick={() => router.push('/app/wallet')}>
            Wallet
          </button>
        </div>
