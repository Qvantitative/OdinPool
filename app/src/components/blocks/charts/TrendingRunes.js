...
const TrendingRunes = () => {
  ...
  const normalizedData = useMemo(() => {
    ...
    // Increased MIN_SIZE and MAX_SIZE for larger bubbles
    const MIN_SIZE = 100;  // Previously 50
    const MAX_SIZE = 500;  // Previously 300
    const margin = 8;      // Increased margin to accommodate larger bubbles
  ...
  return (
    <div className="relative w-full bg-gray-900 rounded-lg overflow-hidden">
      <div className="relative w-full" style={{ minHeight: '800px' }}>  {/* Increased height */}
        <svg
          className="w-full h-[800px]"  {/* Increased height */}
          width="100%"
          height="800"
            ...
            return (
              ...
              >
                ...
                <text
                  textAnchor="middle"
                  dy="-0.3em"
                  fontSize={Math.max(2.2, rune.size / 28)}  // Increased base font size
                  fill="#FFFFFF"
                ...
                <text
                  textAnchor="middle"
                  dy="0.9em"
                  fontSize={Math.max(1.8, rune.size / 32)}  // Increased base font size
